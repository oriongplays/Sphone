...
public class GuiTransfer extends GuiBase {
    ...
    public void GuiInit(){
        ...
        GuiLabel AppTitle = new GuiLabel(I18n.format("sphone.bank.add"));
        AppTitle.setCssId("app_title");
        getRoot().add(AppTitle);

        GuiTextField titre = new GuiTextField();
        titre.setCssClass("titre");
        titre.setHintText(I18n.format("sphone.bank.newReceiver"));
        ...
        note.setHintText(I18n.format("sphone.bank.newAmount"));
        ...
        buttonEdit.addClickListener((mouseX, mouseY, mouseButton) ->
                Minecraft.getMinecraft().player.sendChatMessage("/pay " + titre.getText() + "  " + note.getText())
        );
